<template>
  <section class="pixi__getstarted">
    <pre>
        <a href="https://pixijs.io/examples/#/demos-basic/container.js">https://pixijs.io/examples/#/demos-basic/container.js</a>
    </pre>
  </section>
</template>
<script setup>
...
onMounted(() => {
  document.querySelector(".pixi__getstarted").appendChild(app.view);
});
