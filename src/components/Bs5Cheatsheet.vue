  ...
  <div class="body bg-light">
    ...
    >
      <div class="container-fluid d-flex align-items-center">
        ...
        <a
          href="https://getbootstrap.com/docs/5.2/examples/cheatsheet-rtl/"
      ...
      <section id="content">
        ...
        <article class="my-3" id="images">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/images/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="figures">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/figures/"
              >Documentation</a
            >
          </div>
      ...
      <section id="forms">
        ...
        <article class="my-3" id="disabled-forms">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/overview/#disabled-forms"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="sizing">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/form-control/#sizing"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="input-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/input-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="floating-labels">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/floating-labels/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="validation">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/validation/"
              >Documentation</a
            >
          </div>
      ...
      <section id="components">
        ...
        <article class="my-3" id="badge">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/badge/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="breadcrumb">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/breadcrumb/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="button-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/button-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="carousel">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/carousel/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="list-group">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/list-group/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="pagination">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/pagination/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="progress">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/progress/"
              >Documentation</a
            >
          </div>
          ...
          <div>
            <div class="bd-example-snippet bd-code-snippet">
              <div class="bd-example">
                ...
                <div class="progress mb-3">
                  <div
                    class="progress-bar text-bg-info w-50"
                    role="progressbar"
                ...
                <div class="progress mb-3">
                  <div
                    class="progress-bar text-bg-warning w-75"
                    role="progressbar"
        ...
        <article class="my-3" id="scrollspy">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/scrollspy/"
              >Documentation</a
            >
          </div>
        ...
        <article class="my-3" id="spinners">
          ...
          >
            ...
            <a
              class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/spinners/"
              >Documentation</a
            >
          </div>
