...
export default function (canvas_id) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    if (canvas_id) {
      document.querySelector(canvas_id).appendChild(app.view);
    } else {
  ...
  const trailTexture = PIXI.Texture.from(
    '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#fff" class="bi bi-dot" viewBox="0 0 16 16"><path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/></svg>',
    undefined,
    undefined,
    1.0
  );
