    ...
    <header class="
      ...
      <div class="container-fluid d-flex align-items-center">
        <h1 class="d-flex align-items-center fs-4 text-white mb-0">
          <img src="https://getbootstrap.com/docs/5.2/assets/brand/bootstrap-logo-white.svg" width="38" height="30"
            class="me-3" alt="Bootstrap">
          Cheatsheet
        </h1>
        <a href="https://getbootstrap.com/docs/5.2/examples/cheatsheet-rtl/" class="ms-auto link-light"
    ...
    <aside class="
      ...
      <nav class="small" id="toc">
        <ul class="list-unstyled">
          <li class="my-2">
            <button class="btn d-inline-flex align-items-center border-0" data-bs-toggle="collapse" aria-expanded="true"
              data-bs-target="#contents-collapse" aria-controls="contents-collapse">
              Contents
            </button>
          ...
          <li class="my-2">
            <button class="btn d-inline-flex align-items-center collapsed border-0" data-bs-toggle="collapse"
              aria-expanded="false" data-bs-target="#components-collapse" aria-controls="components-collapse">
              Components
            </button>
      ...
      <section id="content">
        ...
        <article class="my-3" id="typography">
          <div class="
            ...
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/typography/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="images">
          <div class="
            ...
            <h3>Images</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/images/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="tables">
          <div class="
            ...
            <h3>Tables</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/tables/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="figures">
          <div class="
            ...
            <h3>Figures</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/content/figures/">Documentation</a>
          </div>
      ...
      <section id="forms">
        ...
        <article class="my-3" id="overview">
          <div class="
            ...
            <h3>Overview</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/overview/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="disabled-forms">
          <div class="
            ...
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/overview/#disabled-forms">Documentation</a>
          </div>
        ...
        <article class="my-3" id="sizing">
          <div class="
            ...
            <h3>Sizing</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/form-control/#sizing">Documentation</a>
          </div>
        ...
        <article class="my-3" id="input-group">
          <div class="
            ...
            <h3>Input group</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/input-group/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="floating-labels">
          <div class="
            ...
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/floating-labels/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="validation">
          <div class="
            ...
            <h3>Validation</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/forms/validation/">Documentation</a>
          </div>
      ...
      <section id="components">
        ...
        <article class="my-3" id="accordion">
          <div class="
            ...
            <h3>Accordion</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/accordion/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="alerts">
          <div class="
            ...
            <h3>Alerts</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/alerts/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="badge">
          <div class="
            ...
            <h3>Badge</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/badge/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="breadcrumb">
          <div class="
            ...
            <h3>Breadcrumb</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/breadcrumb/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="buttons">
          <div class="
            ...
            <h3>Buttons</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/buttons/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="button-group">
          <div class="
            ...
            <h3>Button group</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/button-group/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="card">
          <div class="
            ...
            <h3>Card</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/card/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="carousel">
          <div class="
            ...
            <h3>Carousel</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/carousel/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="dropdowns">
          <div class="
            ...
            <h3>Dropdowns</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/dropdowns/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="list-group">
          <div class="
            ...
            <h3>List group</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/list-group/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="modal">
          <div class="
            ...
            <h3>Modal</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/modal/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="navs">
          <div class="
            ...
            <h3>Navs</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/navs-tabs/">Documentation</a>
          </div>
                ...
                <nav>
                  <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact"
                      type="button" role="tab" aria-controls="nav-contact" aria-selected="false" tabindex="-1">
                      Contact
                    </button>
                  </div>
                </nav>
        ...
        <article class="my-3" id="navbar">
          <div class="
            ...
            <h3>Navbar</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/navbar/">Documentation</a>
          </div>
              ...
              <div class="bd-example">
                <nav class="navbar navbar-expand-lg bg-light">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                      <img src="https://getbootstrap.com/docs/5.2/assets/brand/bootstrap-logo-white.svg" width="38"
                        height="30" class="d-inline-block align-top" alt="Bootstrap" loading="lazy" style="
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary mt-5">
                  <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                      <img src="https://getbootstrap.com/docs/5.2/assets/brand/bootstrap-logo-white.svg" width="38"
                        height="30" class="d-inline-block align-top" alt="Bootstrap" loading="lazy" />
                    </a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
        ...
        <article class="my-3" id="pagination">
          <div class="
            ...
            <h3>Pagination</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/pagination/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="popovers">
          <div class="
            ...
            <h3>Popovers</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/popovers/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="progress">
          <div class="
            ...
            <h3>Progress</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/progress/">Documentation</a>
          </div>
          ...
          <div>
            <div class="bd-example-snippet bd-code-snippet">
              <div class="bd-example">
                <div class="progress mb-3">
                  <div class="progress-bar" role="progressbar" aria-label="Example with label" aria-valuenow="0"
                    aria-valuemin="0" aria-valuemax="100">
                    0%
                  </div>
                </div>
                <div class="progress mb-3">
                  <div class="progress-bar bg-success w-25" role="progressbar" aria-label="Success example with label"
                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                    25%
                  </div>
                </div>
                <div class="progress mb-3">
                  <div class="progress-bar text-bg-info w-50" role="progressbar" aria-label="Info example with label"
                    aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                    50%
                  </div>
                </div>
                <div class="progress mb-3">
                  <div class="progress-bar text-bg-warning w-75" role="progressbar"
                    aria-label="Warning example with label" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                    75%
                  </div>
                </div>
                <div class="progress">
                  <div class="progress-bar bg-danger w-100" role="progressbar" aria-label="Danger example with label"
            ...
            <div class="bd-example-snippet bd-code-snippet">
              <div class="bd-example">
                <div class="progress">
                  <div class="progress-bar" role="progressbar" aria-label="Segment one - default example"
                    style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                  <div class="
                      progress-bar progress-bar-striped progress-bar-animated
                      bg-success
                    " role="progressbar" aria-label="Segment two - animated striped success example" style="width: 40%"
        ...
        <article class="my-3" id="scrollspy">
          <div class="
            ...
            <h3>Scrollspy</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/scrollspy/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="spinners">
          <div class="
            ...
            <h3>Spinners</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/spinners/">Documentation</a>
          </div>
        ...
        <article class="my-3" id="toasts">
          <div class="
            ...
            <h3>Toasts</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/toasts/">Documentation</a>
          </div>
        ...
        <article class="mt-3 mb-5 pb-5" id="tooltips">
          <div class="
            ...
            <h3>Tooltips</h3>
            <a class="d-flex align-items-center"
              href="https://getbootstrap.com/docs/5.2/components/tooltips/">Documentation</a>
          </div>
